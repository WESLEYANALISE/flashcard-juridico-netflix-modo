...
const ImprovedAnimatedFlashCard = ({
  ...
  return (
    <div className={`max-w-2xl mx-auto relative ${isShaking ? 'animate-[shake_0.6s_ease-in-out]' : ''}`}>
      ...
      `}>
        <div className="w-full min-h-[400px] sm:min-h-[450px] bg-netflix-dark/50 rounded-2xl glass-effect border border-white/20 p-4 sm:p-8 relative overflow-hidden">
          {/* Header */}
