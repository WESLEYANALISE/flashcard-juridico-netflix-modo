        ...
        <div className="w-full min-h-[350px] sm:min-h-[400px] md:min-h-[450px] bg-netflix-dark/50 rounded-xl sm:rounded-2xl glass-effect border border-white/20 p-3 sm:p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-3 sm:mb-4 md:mb-6">
            <div className="flex items-center gap-2 sm:gap-3">
              {tema && (
                <div className="px-2 sm:px-3 py-1 rounded-full text-xs font-medium bg-white/10 text-gray-300">
                  {tema}
                </div>
              )}
            </div>
                ...
                {exemplo && (
                  <div className="space-y-2">
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="bg-netflix-gold/20 border-netflix-gold/50 text-netflix-gold hover:bg-netflix-gold/30 transition-all duration-300 text-xs sm:text-sm"
                    >
                    ...
                    {showExample && (
                      <div className="p-3 sm:p-4 md:p-6 bg-netflix-gold/10 rounded-lg sm:rounded-xl border border-netflix-gold/20 animate-fade-in">
