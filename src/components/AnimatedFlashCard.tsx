...
const AnimatedFlashCard = ({
  ...
  const getCardTransform = () => {
    ...
    if (isExiting) {
      return exitDirection === 'right' ? 'translate-x-full opacity-0 scale-95' : '-translate-x-full opacity-0 scale-95';
    }
    return 'translate-x-0 opacity-100 scale-100';
  };
  return <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl mx-auto relative px-2">
      <div className={`relative transform transition-all duration-300 ease-out ${getCardTransform()}`}>
        ...
        <div className="w-full bg-gradient-to-br from-neutral-900/95 via-neutral-800/95 to-neutral-900/95 rounded-xl sm:rounded-2xl border border-neutral-600/40 overflow-hidden shadow-xl backdrop-blur-lg transition-all duration-200 hover:scale-[1.02]">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative z-10 p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="flex items-center space-x-3">
                  <div className="p-2 rounded-lg shadow-md border backdrop-blur-sm transition-all duration-200" style={{
                  backgroundColor: `${areaColor}20`,
                  borderColor: `${areaColor}40`,
                  boxShadow: `0 2px 8px ${areaColor}15`
                }}>
                    <Scale className="w-4 h-4 sm:w-5 sm:h-5" style={{
                    color: areaColor
                  }} />
                  </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-current to-transparent opacity-60" style={{
            color: areaColor
          }} />
          </div>
          ...
          <div className="p-4 sm:p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="text-center mb-6 relative z-10">
              ...
              <div className="mt-4 p-4 sm:p-6 bg-gradient-to-br from-neutral-800/70 to-neutral-700/50 rounded-xl border border-neutral-600/50 backdrop-blur-md shadow-lg px-[9px]">
              ...
              {exemplo && <div className="mt-6 p-4 sm:p-6 bg-gradient-to-br from-amber-500/10 via-yellow-500/5 to-orange-500/10 rounded-xl border border-amber-500/30 backdrop-blur-md shadow-lg animate-fade-in px-[9px]">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
              <Button onClick={() => handleAnswer(false)} variant="outline" className="bg-rose-500/15 border-rose-500/40 text-rose-300 hover:bg-rose-500/25 hover:border-rose-400/60 transition-all duration-200 px-6 py-3 text-base rounded-lg hover:scale-105 shadow-lg hover:shadow-rose-500/20 font-semibold flex-1 sm:flex-none">
                <XCircle className="w-4 h-4 mr-2" />
                Preciso Revisar
              </Button>
              
              <Button onClick={() => handleAnswer(true)} variant="outline" className="bg-emerald-500/15 border-emerald-500/40 text-emerald-300 hover:bg-emerald-500/25 hover:border-emerald-400/60 transition-all duration-200 px-6 py-3 text-base rounded-lg hover:scale-105 shadow-lg hover:shadow-emerald-500/20 font-semibold flex-1 sm:flex-none">
